      ...
      <div className="card space-y-4">
        ...
        <div className="divide-y divide-white/[0.04] text-sm">
          <div className="flex justify-between py-3">
            ...
            <span className="text-white">{LEAVE_TYPE_LABELS[leave.type] ?? leave.type}</span>
          </div>
          <div className="flex justify-between py-3">
          ...
          <div className="flex justify-between py-3">
            ...
            <span className="text-white font-mono font-bold">{leave.days} jour{leave.days > 1 ? 's' : ''}</span>
          </div>
          {leave.reason && (
            <div className="py-3">
