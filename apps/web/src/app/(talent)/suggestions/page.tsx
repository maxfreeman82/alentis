...
import { Briefcase, MapPin, Building2, Zap, Star, ClipboardList, ChevronRight, TrendingUp, Lock } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <h1 className="font-display text-white text-2xl">Vos opportunités</h1>
      ...
      <div className="card flex items-center gap-4">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-white text-sm font-semibold">{passport.dominant_profile ?? 'Profil'}</p>
        ...
        <div className="hidden sm:flex gap-4 text-center">
          {[
            ...
            <div key={x.label}>
              <p className="font-mono text-base font-bold text-white">{x.v}</p>
...
function JobCard({ job }: {
  ...
  return (
    <div className="card hover:border-white/10 transition-all relative overflow-hidden">
      {job.is_premium && (
