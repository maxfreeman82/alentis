      ...
      <header className="border-b border-slate-200 bg-bg-card sticky top-0 z-40">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            ...
            {[
              ...
              return (
                <Link key={item.href} href={item.href}
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-slate-400 hover:text-slate-800 hover:bg-slate-50 transition-all text-xs">
            ...
            {/* Séparateur */}
            <div className="w-px h-5 bg-slate-50 mx-1" />

            {/* Paramètres */}
            <Link href="/parametres"
              className="p-1.5 rounded-lg text-slate-500 hover:text-slate-800 hover:bg-slate-50 transition-all"
              title="Paramètres">
