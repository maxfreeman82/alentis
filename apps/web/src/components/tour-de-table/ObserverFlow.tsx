  ...
  if (profiles.length === 0) {
    return (
      <div className="text-center py-16 space-y-3">
        <p className="text-slate-900 font-display text-xl">Aucun collègue à observer</p>
  ...
  if (completed.size === profiles.length) {
    return (
      <div className="text-center py-16 space-y-4">
        ...
        <h2 className="font-display text-slate-900 text-2xl">Tour complété</h2>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center space-y-1">
        ...
        <h1 className="font-display text-slate-900 text-xl">Vos observations</h1>
