...
interface Database {
  public: {
    Tables: {
      organizations: {
        Row:    { id: string; name: string; sector: string | null; size: number | null; country: string; city: string | null; cert_level: number; cert_score: number; ias_score: number; archetype: string | null; plan: string; created_at: string };
        Insert: { id?: string; name: string; sector?: string | null; size?: number | null; country?: string; city?: string | null; cert_level?: number; cert_score?: number; ias_score?: number; archetype?: string | null; plan?: string };
